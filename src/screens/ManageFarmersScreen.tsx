...
type ManageFarmersScreenNavigationProp = StackNavigationProp<
  RootStackParamList,
  'ManageFarmers'
>;

type Props = {
  navigation: ManageFarmersScreenNavigationProp;
};
...
const ManageFarmersScreen: React.FC<Props> = ({ navigation }) => {
  const renderItem = ({ item }: { item: typeof farmersData[0] }) => (
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Manage Farmers</Text>
      ...
      />
      <TouchableOpacity style={styles.fab} onPress={() => navigation.navigate('AddFarmer')}>
