...
type RetailerSubmitOrderScreenRouteProp = RouteProp<RootStackParamList, 'RetailerSubmitOrder'>;

type Props = {
  navigation: RetailerSubmitOrderScreenNavigationProp;
  route: RetailerSubmitOrderScreenRouteProp;
};

const RetailerSubmitOrderScreen: React.FC<Props> = ({ navigation, route }) => {
